public class Sort {
    ...
    public static void quickSortInternal(int[] arr,int lowIndex,int highIndex){
        ...
        for(int i = lowIndex+1; i <= highIndex ; i++){
            if(arr[i] < arr[keyIndex]){
                if(i == keyIndex+1){
                    BuildArray.swap(arr,i,keyIndex);
                }else{
                    BuildArray.swap(arr,keyIndex,keyIndex+1);
                    BuildArray.swap(arr,keyIndex,i);
                }
                keyIndex++;
            }
        }
